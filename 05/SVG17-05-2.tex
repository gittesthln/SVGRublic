...
\TITLE{5}{2}{初期化で要素を作成と\\自前のアニメーション}{5/24}
\begin{document}
\frame{\maketitle}
 \section{初期化で要素を作成}
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{svg-cycloid.svg}{1}{19}
\end{frame}
\begin{frame}[containsverbatim]
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{svg-cycloid.svg}{20}{last}
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{svg-cycloid-animation.svg}{1}{14}
\end{frame}
\begin{frame}[containsverbatim]
 \frametitle{サイクロイドのアニメーション}
 \LISTINGFP{7}{svg-cycloid-animation.svg}{15}{31}
\end{frame}
\begin{frame}[containsverbatim]
 \frametitle{サイクロイドのアニメーション}
 \LISTINGFP{7}{svg-cycloid-animation.svg}{32}{last}
\end{frame}
\begin{frame}[containsverbatim]
