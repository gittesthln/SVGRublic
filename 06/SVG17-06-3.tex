...
\TITLE{6}{3}{SVGとHTMLの間でデータを交換する}{5/31}
\begin{document}
\frame{\maketitle}
\section{SVGとHTMLの間でデータ交換}
\begin{frame}[containsverbatim]
 \frametitle{ソースコード(1)}
 \LISTINGFP{7}{ShowSetClickPos4.html}{1}{12}
 \begin{itemize}
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{13}{20}
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{21}{35}
\end{frame}
\begin{frame}[containsverbatim]
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{36}{57}
\end{frame}
\begin{frame}[containsverbatim]
...
\end{frame}
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{58}{60}
  \begin{itemize}
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{61}{80}
\end{frame}
\begin{frame}[containsverbatim]
...
\begin{frame}[containsverbatim]
 ...
 \LISTINGFP{7}{ShowSetClickPos4.html}{81}{last}
 \begin{itemize}
