...
\end{frame}
\begin{frame}[containsverbatim]
 \frametitle{\ELM{form}の例(5)}\small
 \LIST{06-1example.html}{50}{last}
 \end{frame}
\begin{frame}[containsverbatim]
